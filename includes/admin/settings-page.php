...
function aludra_get_block_categories() {
	return array(
		'aludra-hero'       => __( 'Heroes', 'aludra' ),
		'aludra-proof'      => __( 'Proof', 'aludra' ),
		'aludra-features'   => __( 'Features & Services', 'aludra' ),
		'aludra-layout'     => __( 'Layout', 'aludra' ),
		'aludra-convert'    => __( 'Convert', 'aludra' ),
		'aludra-navigation' => __( 'Navigation', 'aludra' ),
	);
}
