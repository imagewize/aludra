<?php
/**
 * Title: Mega Menu - Icon Grid
 * Slug: aludra/mega-menu-icon-grid
 * Categories: aludra
...
<h4 class="wp-block-heading has-text-align-center"><a href="#">Free Shipping</a></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="wp-block-heading has-text-align-center"><a href="#">Secure Payment</a></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="wp-block-heading has-text-align-center"><a href="#">Easy Returns</a></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="wp-block-heading has-text-align-center"><a href="#">24/7 Support</a></h4>
<!-- /wp:heading -->
