...
**File:** `/Users/jasperfrumau/code/aludra/blocks/mega-menu/src/render.php`
**Line:** 119

The `data-wp-interactive` attribute is using an incorrect JSON format:

```php
data-wp-interactive='{"namespace": "aludra/mega-menu"}'
```
...
- `/Users/jasperfrumau/code/aludra/screenshots/`
