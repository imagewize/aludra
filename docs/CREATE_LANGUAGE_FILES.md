# Creating Language Files for Aludra

## Overview
This guide explains how to create and maintain language files for the Aludra plugin to support internationalization.

## Current State
- ✅ Plugin header has `Text Domain: aludra`
- ✅ Plugin header has `Domain Path: /languages`
- ✅ All blocks use consistent text domain `aludra`
...
wp i18n make-pot . --domain=aludra --exclude="node_modules,build,vendor,tests" --dest-file=languages/aludra.pot
```
...
2. Open the `.pot` file
3. Save as `.po` file (e.g., `aludra-nl_NL.po` for Dutch)
...
```
aludra.pot          # Template file (generated)
aludra-nl_NL.po      # Dutch translation
aludra-nl_NL.mo      # Compiled Dutch translation
aludra-de_DE.po      # German translation
aludra-de_DE.mo      # Compiled German translation
```
...
1. **Keep text domain consistent**: Always use `aludra`
...
https://translate.wordpress.org/projects/wp-plugins/aludra
