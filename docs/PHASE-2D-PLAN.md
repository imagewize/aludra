...
**What we're building:**
- `aludra/mega-menu-column` - Column container for grid layouts
- `aludra/mega-menu-section` - Heading + content grouping
- `aludra/mega-menu-item` - Individual menu item with icon/description/badge
...
```
aludra/mega-menu (parent block)
└─ InnerBlocks (accepts any blocks)
   ├─ aludra/mega-menu-column (optional, for grid layouts)
   │  └─ aludra/mega-menu-section (optional, for grouping)
   │     └─ aludra/mega-menu-item (leaf block)
   │        OR core blocks (paragraph, image, etc.)
   │        OR template parts
   ├─ aludra/mega-menu-section (can be used directly)
   │  └─ aludra/mega-menu-item
...
export default function Save({ attributes }) {
  ...
  const blockProps = useBlockProps.save({
    className: classnames(
      'wp-block-aludra-mega-menu-column',
      `width-${width.replace('/', '-')}`,
      `align-${verticalAlignment}`
    ),
    style: {
...
export default function Edit({ attributes, setAttributes }) {
  ...
  const blockProps = useBlockProps({
    className: 'wp-block-aludra-mega-menu-section',
  });
  ...
  return (
    <>
      ...
      <div {...blockProps}>
        <div className="wp-block-aludra-mega-menu-section__header">
          {iconName && !customSVG && (
          ...
          <RichText
            ...
            className="wp-block-aludra-mega-menu-section__heading"
          />
        </div>

        <div className="wp-block-aludra-mega-menu-section__content">
          <InnerBlocks
            allowedBlocks={[
              'aludra/mega-menu-item',
              'core/paragraph',
...
export default function Save({ attributes }) {
  ...
  const blockProps = useBlockProps.save({
    className: classnames('wp-block-aludra-mega-menu-section', {
...
```scss
.wp-block-aludra-mega-menu-section {
  margin-bottom: 24px;
...
export default function Edit({ attributes, setAttributes }) {
  ...
  const blockProps = useBlockProps({
    className: 'wp-block-aludra-mega-menu-item',
  });
  ...
  return (
    <>
      ...
      <div {...blockProps}>
        <a
          className="wp-block-aludra-mega-menu-item__link"
          href={linkUrl || '#'}
          target={linkTarget}
        >
          {iconName && !customSVG && (
          ...
          <div className="wp-block-aludra-mega-menu-item__content">
            <div className="wp-block-aludra-mega-menu-item__header">
              <RichText
                tagName="span"
                value={label}
                onChange={(val) => setAttributes({ label: val })}
                placeholder="Item label..."
                className="wp-block-aludra-mega-menu-item__label"
              />
              {badgeText && (
                <span
                  className={classnames(
                    'wp-block-aludra-mega-menu-item__badge',
                    `badge-${badgeStyle}`
                  )}
                >
                  {badgeText}
            ...
            {description && (
              <RichText
                ...
                className="wp-block-aludra-mega-menu-item__description"
              />
            )}
          </div>
        </a>
...
```scss
.wp-block-aludra-mega-menu-item {
  margin-bottom: 8px;
...
<InnerBlocks
  ...
  template={[
    ['aludra/mega-menu-section', {
      ...
      ['aludra/mega-menu-item', { label: 'All Products', linkUrl: '/products' }],
      ['aludra/mega-menu-item', { label: 'Featured', linkUrl: '/featured', badgeText: 'New', badgeStyle: 'info' }],
    ]],
  ]}
/>
```
...
register_block_pattern(
  ...
  array(
    'title' => __('Mega Menu - Three Column Layout', 'aludra'),
    'description' => __('Three column mega menu with sections and items', 'aludra'),
    'categories' => array('aludra'),
    'content' => '<!-- wp:aludra/mega-menu -->
      <!-- wp:aludra/mega-menu-column {"width":"1/3"} -->
        <!-- wp:aludra/mega-menu-section {"heading":"Products"} -->
          <!-- wp:aludra/mega-menu-item {"label":"All Products","linkUrl":"/products"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"New Arrivals","linkUrl":"/new","badgeText":"New","badgeStyle":"info"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"Best Sellers","linkUrl":"/bestsellers"} /-->
        <!-- /wp:aludra/mega-menu-section -->
      <!-- /wp:aludra/mega-menu-column -->

      <!-- wp:aludra/mega-menu-column {"width":"1/3"} -->
        <!-- wp:aludra/mega-menu-section {"heading":"Categories"} -->
          <!-- wp:aludra/mega-menu-item {"label":"Electronics","linkUrl":"/electronics"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"Clothing","linkUrl":"/clothing"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"Home & Garden","linkUrl":"/home"} /-->
        <!-- /wp:aludra/mega-menu-section -->
      <!-- /wp:aludra/mega-menu-column -->

      <!-- wp:aludra/mega-menu-column {"width":"1/3"} -->
        <!-- wp:aludra/mega-menu-section {"heading":"Support"} -->
          <!-- wp:aludra/mega-menu-item {"label":"Help Center","linkUrl":"/help"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"Contact Us","linkUrl":"/contact"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"FAQ","linkUrl":"/faq"} /-->
        <!-- /wp:aludra/mega-menu-section -->
      <!-- /wp:aludra/mega-menu-column -->
    <!-- /wp:aludra/mega-menu -->',
  )
...
```php
register_block_pattern(
  'aludra/mega-menu-featured',
  array(
    'title' => __('Mega Menu - Featured Product', 'aludra'),
    'description' => __('Two column layout with featured product image', 'aludra'),
    'categories' => array('aludra'),
    'content' => '<!-- wp:aludra/mega-menu -->
      <!-- wp:aludra/mega-menu-column {"width":"2/3"} -->
        <!-- wp:aludra/mega-menu-section {"heading":"Shop by Category"} -->
          <!-- wp:aludra/mega-menu-item {"label":"Women\'s Fashion","iconName":"admin-users","linkUrl":"/womens"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"Men\'s Fashion","iconName":"admin-users","linkUrl":"/mens"} /-->
          <!-- wp:aludra/mega-menu-item {"label":"Accessories","iconName":"star-filled","linkUrl":"/accessories","badgeText":"Sale","badgeStyle":"danger"} /-->
        <!-- /wp:aludra/mega-menu-section -->
      <!-- /wp:aludra/mega-menu-column -->

      <!-- wp:aludra/mega-menu-column {"width":"1/3","backgroundColor":"#f5f5f5"} -->
        <!-- wp:heading {"level":4} -->
...
- `aludra.php` (register 2 new block patterns)
