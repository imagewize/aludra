...
const ANIMATION_TYPES = [
	{
		value: 'fade',
		label: __( 'Fade', 'aludra' ),
		description: __( 'Smooth fade in/out effect', 'aludra' ),
		icon: '○',
	},
	{
		value: 'slide',
		label: __( 'Slide', 'aludra' ),
		description: __( 'Slide down from top', 'aludra' ),
		icon: '↓',
	},
	{
		value: 'scale',
		label: __( 'Scale', 'aludra' ),
		description: __( 'Grow from center', 'aludra' ),
		icon: '⊕',
	},
	{
		value: 'slidefade',
		label: __( 'Slide + Fade', 'aludra' ),
		description: __( 'Combined slide and fade', 'aludra' ),
		icon: '⤓',
	},
];
 ...
 */
const SPEED_PRESETS = [
	{ value: 150, label: __( 'Fast', 'aludra' ) },
	{ value: 300, label: __( 'Normal', 'aludra' ) },
	{ value: 500, label: __( 'Slow', 'aludra' ) },
];
...
export default function AnimationControls( {
	...
	return (
		<div className="aludra-animation-controls">
			{ /* Animation Type Selector */ }
			<BaseControl
				label={ __( 'Animation Type', 'aludra' ) }
				help={ __(
			...
			<div style={ { marginTop: '20px' } }>
				<BaseControl
					label={ __( 'Animation Speed', 'aludra' ) }
				>
					{ /* Speed Presets */ }
					<div
						style={ {
