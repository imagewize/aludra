...
export default function Edit( { attributes, setAttributes } ) {
	...
	const menuTemplateUrl =
		...
		'/wp-admin/site-editor.php?p=%2Fpattern&postType=wp_template_part&categoryId=aludra-mega-menu';
		...
		<>
			...
			<BlockControls>
				<ToolbarGroup>
					<ToolbarButton
						...
						label={ __( 'Enable Animations', 'aludra' ) }
			...
			<InspectorControls group="settings">
				...
				<PanelBody
					...
					title={ __( 'Settings', 'aludra' ) }
					initialOpen={ true }
				>
					<TextControl
						label={ __( 'Label', 'aludra' ) }
						type="text"
						value={ label }
						onChange={ ( value ) =>
					...
					<ComboboxControl
						label={ __( 'Select Menu Template', 'aludra' ) }
						value={ menuSlug }
						options={ menuOptions }
						onChange={ ( value ) =>
				...
				{ /* Mobile Panel */ }
				<PanelBody
					title={ __( 'Mobile Behavior', 'aludra' ) }
					initialOpen={ false }
				>
					<ToggleControl
						label={ __( 'Enable Mobile Mode', 'aludra' ) }
			...
			{ /* Block Preview */ }
			<div { ...blockProps }>
				<button className="wp-block-navigation-item__content wp-block-aludra-mega-menu__toggle">
					<RichText
						identifier="label"
