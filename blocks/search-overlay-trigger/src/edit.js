...
export default function Edit( { attributes, setAttributes } ) {
	const { overlayBackgroundColor, searchBarBorderColor, closeButtonColor } =
		attributes;
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={ __( 'Overlay Settings', 'aludra' ) }
					initialOpen={ true }
				>
					<ColorGradientControl
						...
						onColorChange={ ( color ) =>
							setAttributes( { overlayBackgroundColor: color } )
						}
						enableAlpha={ true }
					/>
					<ColorGradientControl
						...
						onColorChange={ ( color ) =>
							setAttributes( { searchBarBorderColor: color } )
						}
						enableAlpha={ false }
					/>
					<ColorGradientControl
