    ...
    $(document).ready(function() {
        $('.wp-block-aludra-carousel').each(function() {
            ...
            if (hasThumbnails) {
                ...
                $slider.find('.wp-block-aludra-slide').each(function(index) {
                    const $slide = $(this);
            ...
            setTimeout(function() {
                ...
                if ($prevArrow.length && $nextArrow.length) {
                    ...
                    const arrowSvgs = {
                        'chevron': aludraBlocksData.pluginUrl + 'blocks/carousel/src/arrows/chevron.svg',
                        'caret': aludraBlocksData.pluginUrl + 'blocks/carousel/src/arrows/caret.svg',
                        'arrow': aludraBlocksData.pluginUrl + 'blocks/carousel/src/arrows/arrow.svg'
                    };
