			...
			<InspectorControls>
				...
				>
					...
					{ centerMode && (
						<RangeControl
							...
							help={ __(
								'Amount of adjacent slides visible',
								'aludra'
							) }
							value={ parseInt( centerPadding ) }
							onChange={ ( value ) =>
								setAttributes( {
									centerPadding: `${ value }px`,
								} )
							}
							min={ 0 }
							max={ 200 }
					...
					{ enableThumbnails && (
						<>
							<RangeControl
								...
								onChange={ ( value ) =>
									setAttributes( { thumbnailsToShow: value } )
								}
								min={ 2 }
								max={ 10 }
							/>
							<SelectControl
								...
								options={ [
									{
										label: __( 'Below', 'aludra' ),
										value: 'below',
									},
									{
										label: __( 'Above', 'aludra' ),
										value: 'above',
									},
									{
				...
				>
					...
					<SelectControl
						...
						help={ __(
							'Improves performance for image-heavy carousels',
							'aludra'
						) }
						value={ lazyLoad }
						options={ [
							...
							{
								label: __( 'On Demand', 'aludra' ),
								value: 'ondemand',
							},
							{
								label: __( 'Progressive', 'aludra' ),
								value: 'progressive',
							},
						] }
						onChange={ ( value ) =>
					...
					<ToggleControl
						...
						help={ __(
							'Auto-adjust height to match active slide',
							'aludra'
						) }
				...
				{ arrows && (
					...
					>
						<SelectControl
							...
							options={ [
								{
									label: __( 'Arrow (Default)', 'aludra' ),
									value: 'arrow',
								},
								{
									label: __( 'Chevron', 'aludra' ),
									value: 'chevron',
								},
								{
									label: __( 'Caret (Triangle)', 'aludra' ),
									value: 'caret',
								},
								{
									label: __( 'Custom SVG', 'aludra' ),
									value: 'custom',
								},
							] }
							onChange={ ( value ) =>
							...
							help={ __(
								'Choose the arrow icon style - all icons are SVG-based for sharp, scalable rendering',
								'aludra'
							) }
						/>
						{ arrowStyle === 'custom' && (
							<TextareaControl
								...
								onChange={ ( value ) =>
									setAttributes( { customArrowSvg: value } )
								}
								help={ __(
									'Paste SVG code for custom arrow icon',
									'aludra'
								) }
								rows={ 4 }
							/>
						...
						<SelectControl
							...
							options={ [
								{
									label: __( 'Circle', 'aludra' ),
									value: 'circle',
								},
								{
									label: __( 'Rounded Square', 'aludra' ),
									value: 'rounded',
								},
								{
									label: __( 'Square', 'aludra' ),
									value: 'square',
								},
								{
									label: __( 'None', 'aludra' ),
									value: 'none',
								},
							] }
							onChange={ ( value ) =>
								setAttributes( { arrowBackgroundStyle: value } )
							}
							help={ __(
								'Choose the arrow background shape',
								'aludra'
							) }
						/>
						<RangeControl
				...
				>
					<RangeControl
						...
						onChange={ ( value ) =>
							setAttributes( { responsiveWidth: value } )
						}
						min={ 320 }
						max={ 1200 }
						step={ 1 }
					...
					<RangeControl
						...
						onChange={ ( value ) =>
							setAttributes( { responsiveSlides: value } )
						}
						min={ 1 }
						max={ 5 }
					/>
					<RangeControl
						...
						onChange={ ( value ) =>
							setAttributes( { responsiveSlidesToScroll: value } )
						}
						min={ 1 }
						max={ 5 }
					/>
				...
				<PanelBody
					title={ __( 'Advanced', 'aludra' ) }
					initialOpen={ false }
				>
					<RangeControl
						label={ __( 'Total Slides', 'aludra' ) }
						help={ __(
							'Number of slide blocks to generate',
							'aludra'
						) }
						value={ slides }
						onChange={ ( value ) =>
